...
document.querySelector('#app').innerHTML = `
  ...
  <main id="top">
    ...
    <section id="contact" class="contact section-wrap"><p class="eyebrow">03 / Start a conversation</p><div class="contact-content"><h2>Have a good<br /><em>idea in motion?</em></h2><a class="contact-link" href="mailto:kelvinnjaunjino@gmail.com">kelvinnjaunjino@gmail.com <span>↗</span></a><a class="contact-link" href="tel:+254743254292">0743254292 <span>↗</span></a></div><div class="contact-bottom"><p>For partnerships, product thinking, and digital growth conversations across Kenya and beyond.</p><div class="social-links"><a href="https://www.linkedin.com/in/kelvin-njau" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href="https://github.com/v0qeh" target="_blank" rel="noreferrer">GitHub ↗</a></div></div></section>
  </main>
